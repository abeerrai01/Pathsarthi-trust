      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="mb-2">
            ...
            <a href="tel:+919310757350" className="text-indigo-700 underline">+91-9310757350</a>
            {' | '}
            <a href="tel:+919837004175" className="text-indigo-700 underline">+91-9837004175</a>
          </div>
