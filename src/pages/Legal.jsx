...
const Legal = () => {
  const members = [
    ...
    { name: 'Advocate Paramveer Singh', gender: 'Male', designation: 'Legal Consultant', joinedDate: '2025-07-08', image: '/Paramveer singh.jpg', address: 'Baghpat, Uttar Pradesh', mobile: '9758933155' }
  ];
  ...
  return (
    <div className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold mb-6">Legal Consultant</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Meet our legal advisor who guides Path Sarthi Trust in all legal matters.
          </p>
        </motion.div>
