...
const Blog = () => {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <h1 className="text-4xl font-extrabold mb-8 text-center font-serif bg-gradient-to-r from-blue-300 via-blue-400 to-orange-300 bg-clip-text text-transparent drop-shadow-lg">Interns' Featured Articles</h1>
      <div className="space-y-6">
        {articles.map(article => (
          ...
          >
            ...
            <p className="text-md text-blue-700 mb-2 font-cute">by {article.author}</p>
