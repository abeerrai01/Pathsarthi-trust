...
const Doctor = () => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        const q = query(collection(db, 'advisory_volunteers'), where('type', '==', 'Health'));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            ...
            <div className="col-span-full text-center text-gray-500 py-10">No health advisory volunteers found.</div>
          ) : (
