        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/mission" className="text-gray-300 hover:text-white text-sm">
                  Our Mission
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-gray-300 hover:text-white text-sm">
                  Gallery
                </Link>
              </li>
              <li>
                <Link to="/donate" className="text-gray-300 hover:text-white text-sm">
                  Support Us
                </Link>
              </li>
              <li>
                <Link to="/social-media" className="text-gray-300 hover:text-white text-sm">
                  Social Media
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-gray-300">
                <a href="mailto:pathsarthi2022@gmail.com" className="hover:text-white">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/pathsarthi#"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/path-sarthi-trust"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white"
              >
