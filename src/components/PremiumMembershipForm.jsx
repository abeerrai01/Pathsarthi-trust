      ...
      {step !== 'done' && (
        <div className="relative z-20 flex flex-col items-center text-center mb-8 animate-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="flex flex-col items-center bg-white border-2 border-[#1E293B] shadow-geom-soft rounded-2xl px-8 py-6 max-w-lg">
            ...
            />
            <h2 className="text-3xl md:text-4xl font-outfit font-extrabold text-geom-foreground mb-2 tracking-tight">Support Our Mission</h2>
            <p className="text-sm font-medium text-slate-500 uppercase tracking-widest border-b-2 border-dashed border-slate-200 pb-3 mb-2">Premium Membership / Sponsorship</p>
            <p className="text-base text-slate-600 font-medium">Be a catalyst for hope. <span className="font-outfit font-bold text-[#8B5CF6] text-xl">Flexible Contributions</span></p>
          </div>
        </div>
      )}
            ...
            {paymentMethod === 'razorpay' ? (
              ...
              <div className="w-full flex flex-col gap-4 mt-2">
                ...
                <div className="bg-[#E0F2FE] border-2 border-[#1E293B] rounded-xl shadow-geom-soft p-4 text-sm text-[#1E293B] font-jakarta font-medium leading-relaxed my-2">
                  <span className="font-bold">Scan QR or copy UPI ID to pay ₹{amount}.</span>
                  <br /><br />
...
export default PremiumMembershipForm; 